...
describe("Test basic CRUD for Currencies", function() {

    it("Test basic CRUD for Currencies", done=> {
        ...
        superagent
            ...
            return superagent
                .get(urlBase+'/currencies/'+firstNewId)
            ...
            // 4. Update the record.
            return superagent
                .put(urlBase+'/currencies/'+firstNewId)
            ...
            return superagent
                .del(urlBase+'/currencies/'+firstNewId)
