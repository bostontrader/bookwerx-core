...
const getMany = function({apiKey, collName, expectedCnt, expectedError, fExpectSuccess, httpClient, pn, priorResults, requestSig}) {
  ...
  return new Promise( (resolve, reject) => {
    ...
    httpClient.get(url, function (err, req, res, obj) {
      ...
      if (obj.length !== expectedCnt)
        reject('Expecting ' + expectedCnt + ' documents, found ' + obj.length + ' documents')
