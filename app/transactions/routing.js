...
// })
  ...
  /*
  The transaction dashboard contains a list of all distributions for a particular transaction, listed in no particular order, as well as other various joined fields such as a currency symbol. In addition, we also want info from the transaction document itself.
  ...
  "note": ...
    ...
    We produce this with two queries to the db.  One to get the transaction info, and one to get the distribution (and joined) info.

    Even though account and currency are arrays (cuz that's how mongo rolls), in this app, there should only be exactly one of each.
